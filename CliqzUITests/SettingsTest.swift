...
class SettingsTests: KIFTestCase {
    ...
    func testSearchEngineChange() {
        ...
        checkSearchEngineChange("Wikipedia", query: "germany", url: "https://en.m.wikipedia.org/wiki/Special:Search?search=germany")
    ...
    func testViewHumanWebSettings(){
        ...
        let humanWebSlider = tester.waitForView(withAccessibilityLabel: "Human Web Switch")
    ...
    func testViewAdBlockSettings(){
        ...
        let adBlockSlider = tester.waitForView(withAccessibilityLabel: "AdBlock Switch")
