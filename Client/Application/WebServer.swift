...
class WebServer {
    ...
    func start() throws -> Bool{
        if !server.running {
            try server.startWithOptions([GCDWebServerOption_Port: 6577, GCDWebServerOption_BindToLocalhost: true, GCDWebServerOption_AutomaticallySuspendInBackground: true])
        }
