...
class SearchSettingsTableViewController: UITableViewController {
    ...
    fileprivate let SectionSearchAdd = 2
    ...
    override func viewDidLoad() {
        ...
        if !(self.navigationController is SettingsNavigationController) {
            self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: Strings.SettingsSearchDoneButton, style: .done, target: self, action: #selector(SearchSettingsTableViewController.dismissAnimated))
        }
