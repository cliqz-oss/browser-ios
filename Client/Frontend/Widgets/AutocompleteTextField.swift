...
class AutocompleteTextField: UITextField, UITextFieldDelegate {
    ...
    fileprivate func commonInit() {
        ...
        clearButton.setImage(clearImg, for: UIControlState())
        clearButton.frame = CGRect(x: 0, y: 0, width: 30, height: 30)
        clearButton.addTarget(self, action: #selector(AutocompleteTextField.SELtextDidClear(_:)), for: UIControlEvents.touchUpInside)
    ...
    func SELtextDidClear(_ textField: UITextField) {
