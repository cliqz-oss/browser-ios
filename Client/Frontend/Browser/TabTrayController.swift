...
// MARK: Selectors
    ...
    func SELdidTogglePrivateMode() {
        ...
        if privateTabsAreEmpty() {
            ...
            let newSnapshot = collectionView.snapshotView(afterScreenUpdates: !exitingPrivateMode)
...
fileprivate class TabManagerDataSource: NSObject, UICollectionViewDataSource {
    ...
    init(tabs: [Tab], cellDelegate: TabCellDelegate & SwipeAnimatorDelegate) {
    ...
    @objc func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if !tab.displayTitle.isEmpty {
            ...
            tabCell.accessibilityLabel = AboutUtils.getAboutComponent(tab.url as! URL)
        }
...
fileprivate class EmptyPrivateTabsView: UIView {
    ...
    fileprivate var learnMoreButton: UIButton = {
        ...
        button.setTitle(
            ...
            for: UIControlState())
        button.setTitleColor(UIConstants.PrivateModeTextHighlightColor, for: .normal)
...
class TrayToolbar: UIView {
    ...
    fileprivate func styleToolbar(_ isPrivate: Bool) {
        ...
        updateMaskButtonState(isPrivate)
    }

    fileprivate func updateMaskButtonState(_ isPrivate: Bool) {
