...
open class HistorySynchronizer: IndependentRecordSynchronizer, Synchronizer {
    ...
    fileprivate let batchSize: Int = 500  // A balance between number of requests and per-request size.
    ...
    fileprivate func go(_ info: InfoCollections, greenLight: @escaping () -> Bool, downloader: BatchingDownloader<HistoryPayload>, history: SyncableHistory) -> Success {
